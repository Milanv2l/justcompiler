    ...
    class JustCompilerApp(App[None]):
        ...
        def action_help(self):
            txt = (
                ...
                "\n========================"
                "\n\nHOME SCREEN"
                "\n  n         New build (path or git URL)"
                "\n  s         Settings screen"
                "\n  r         Refresh recent builds list"
                "\n  enter     Open selected build details / artifacts"
                "\n  q         Quit"
                "\n\nBUILD FORM"
                "\n  enter     Continue (git URL -> branch picker)"
                "\n  esc       Back to home"
                "\n\nBRANCH PICKER"
                "\n  arrows    Navigate branches"
                "\n  enter     Select branch and start build"
                "\n  esc       Back to form"
                "\n\nLIVE BUILD"
                "\n  c         Cancel build (kills sandbox container)"
                "\n  l         Toggle raw output log on/off"
                "\n  esc       When finished -> Artifacts or Failure screen"
                "\n\nARTIFACTS"
                "\n  r         Run selected artifact"
                "\n  o         Open build folder in file manager"
                "\n  p         Create packages (deb/rpm/AppImage/flatpak/exe)"
                "\n  i         Install host dependencies"
                "\n  u         Undo last host dependency install"
                "\n  esc       Back to Home"
                "\n\nSETTINGS"
                "\n  esc       Back to Home"
                "\n  Switches and selects save instantly"
                "\n\nGLOBAL"
                "\n  ? or F1   This help overlay"
                "\n\nHEADLESS MODE"
                "\n  justcompiler.py --build <path|url> [options]"
                "\n    --branch B        Pick a specific branch"
                "\n    --target NAME     Force a specific plugin"
                "\n    --all-targets     Build every detected subproject"
                "\n    --package deb,rpm Create packages after build"
                "\n\nDAEMON"
                "\n  justcompiler.py serve   HTTP API on port 7400"
                "\n"
            )
